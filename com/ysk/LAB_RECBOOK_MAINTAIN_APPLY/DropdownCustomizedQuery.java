...
public class DropdownCustomizedQuery extends _bQuery {
	...
	public String getFilter()throws Throwable{
		...
		// 研發"處" 所以取ParentNo
		// 研發一 二課 的人 上一層是研發處 : LAB_RECBOOK_MAINTAIN_APPLY_FINAL_CONFIG.RD_DEPT_NO = 13,此處用 getParentNo 涵蓋 一 ,二課 & 研發處的人
		...
		}// 品管"課": LAB_RECBOOK_MAINTAIN_APPLY_FINAL_CONFIG.QC_DEPT_NO = 18 或品管課底下的理化組等...
		...
		if(getRow()==-1){
			...
			return "and a.PNO = b.PNO and b.F_INP_STAT = '歸檔' " + otherConditionString;
		}
	}
